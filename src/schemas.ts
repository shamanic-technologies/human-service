...
export const AudienceSchema = z
  .object({
    ...
    avatarUrl: z.string().nullable().openapi({
      description:
        "Audience avatar as a self-contained data: URI (image bytes generated by chat-service via POST /orgs/audiences/{id}/avatar). null until generated.",
    }),
...
registry.registerPath({
  ...
  summary:
    "(Re)generate the audience's avatar via chat-service and persist it as a data: URI",
  security: [{ apiKey: [] }],
  request: {
    headers: peopleHeaders,
    params: z.object({ id: z.string().uuid() }),
