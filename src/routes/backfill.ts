...
// audience whose avatar_url is null. Swept server-side over all orgs.
//
// - Scoped to status<>'deprecated' AND avatar_url IS NULL -> idempotent
//   (a re-run only sees rows still null).
